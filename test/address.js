...
describe('Address', function() {
  ...
  var buf = Buffer.concat([new Buffer([0x37]), pubkeyhash]);
  var str = 'PE5jwGLGksLRwWK3bMbGckeVyaJNktRHkP';
  ...
  // livenet valid
  var PKHLivenet = [
    'PEX7F3DYa3nwDjfeQsEeKv9wNQL1iHqoAC',
    'PP3wkjhSdgrCvETVobv4owdqpQKJT2eC5J',
    'PAkJKRzEy1noqV2sD8zzatJE2J1JomCNrY',
    'PDNdPdiAZ8MBgTWzGbE5jWfsaiJqTci6kb',
    '    PSHaqGdC1eAbahBwRiK9EyGDN2JykKmfBx   \t\n'
  ];

  // livenet p2sh
  var P2SHLivenet = [
    '5JH1a2UCJVLAy6ucEdP4HqWN2j4dopUXaA',
    '557QUKYK3Avxbyw2J1s8XqNBRJW6PFYVRz',
    '5B2nxfBGrQU4sfaneiTWVLfKMx9Lfyk2qe',
    '5PRtPyyZn83MvaMjtcGPeNRy3Tzsv4zbsE',
    '\t \n5PRtPyyZn83MvaMjtcGPeNRy3Tzsv4zbsE \r'
  ];

  // testnet p2sh
  var P2SHTestnet = [
    '6fg9c8Q5bmRjBchW8L3yYwuEPDZqWXmz4a',
    '6wqGTMk6GuDSKxj4CsM1nconHdC3GpjFS9',
    '6mAKtXKUU5WMmhwTf76vxQ6jTBH7eH9oWy',
    '6yfBTxLvaHLXtEad1UGtCU7gmA1Bpr9HAT'
  ];
  ...
  //testnet valid
  var PKHTestnet = [
    'qXyj7VZ2h45fEYLWD7znYyCwUvYkc5e3NY',
    'qMFWqxMgTAJ6fyW32ujk1d1AEoW3S8r3K4',
    'qNxJX4jchD88VP82QdwLQsXAQ8QWfyZdNc',
    'qUgarFJjt6N6CVXELejgqqVNZrD3DF1tbJ'
  ];

  describe('validation', function() {

    it('getValidationError detects network mismatchs', function() {
      var error = Address.getValidationError('5JH1a2UCJVLAy6ucEdP4HqWN2j4dopUXaA', 'testnet');
      should.exist(error);
    });

    it('isValid returns true on a valid address', function() {
      var valid = Address.isValid('5JH1a2UCJVLAy6ucEdP4HqWN2j4dopUXaA', 'livenet');
      valid.should.equal(true);
    });

    it('isValid returns false on network mismatch', function() {
      var valid = Address.isValid('5JH1a2UCJVLAy6ucEdP4HqWN2j4dopUXaA', 'testnet');
    ...
    it('addresses with whitespace are validated correctly', function() {
      var ws = '  \r \t    \n PUuyyWFCQQokimk2B13Qem7ZEvS549LWqo \t \n            \r';
      var error = Address.getValidationError(ws);
      should.not.exist(error);
      Address.fromString(ws).toString().should.equal('PUuyyWFCQQokimk2B13Qem7ZEvS549LWqo');
    });
  });
  ...
  describe('encodings', function() {
    ...
    it('should make this address from a compressed pubkey', function() {
      ...
      address.toString().should.equal('PHGTEt6gb1hWqjRESAiQEHSqFjdW9zAURr');
    });
    ...
    it('should make this address from an uncompressed pubkey', function() {
      ...
      a.toString().should.equal('PDthwgMaMQC9epcqKAbbY9bEUS41ursKEs');
      var b = new Address(pubkey, 'livenet', 'pubkeyhash');
      b.toString().should.equal('PDthwgMaMQC9epcqKAbbY9bEUS41ursKEs');
    });
    ...
    describe('from a script', function() {
      ...
      it('should make this address from a p2pkh output script', function() {
        ...
        a.toString().should.equal('PSuKxxTSJCcnzim77o1DxUmhr27vUUfUvm');
        var b = new Address(s, 'livenet');
        b.toString().should.equal('PSuKxxTSJCcnzim77o1DxUmhr27vUUfUvm');
      });
      ...
      it('should make this address from a p2sh input script', function() {
        ...
        var a = Address.fromScript(s, 'livenet');
        a.toString().should.equal('5HbfHKbJTQp3Vd4VeQqrfDZXQsE8uAzoAw');
        var b = new Address(s, 'livenet');
        b.toString().should.equal('5HbfHKbJTQp3Vd4VeQqrfDZXQsE8uAzoAw');
      });

      it('returns the same address if the script is a pay to public key hash out', function() {
        var address = 'PEX7F3DYa3nwDjfeQsEeKv9wNQL1iHqoAC';
      ...
      it('returns the same address if the script is a pay to script hash out', function() {
        var address = '5JH1a2UCJVLAy6ucEdP4HqWN2j4dopUXaA';
  ...
  describe('#toBuffer', function() {
    ...
    it('3c3fa3d4adcaf8f52d5b1843975e122548269937 corresponds to hash PE5jwGLGksLRwWK3bMbGckeVyaJNktRHkP', function() {
      var address = new Address(str);
  ...
  describe('#inspect', function() {
    it('should output formatted output correctly', function() {
      var address = new Address(str);
      var output = '<Address: PE5jwGLGksLRwWK3bMbGckeVyaJNktRHkP, type: pubkeyhash, network: livenet>';
  ...
  describe('creating a P2SH address from public keys', function() {
    ...
    it('can create an address from a set of public keys', function() {
      ...
      address.toString().should.equal('5GarJyDJFJFEkHTvbYRa7bv1dS5t4L38CN');
    ...
    it('works on testnet also', function() {
      ...
      address.toString().should.equal('6swGFQQT626k222GhDkr471A9T7et4fqgt');
    });
